...
const testimonios = [
  {
    nombre: 'María y Juan',
    evento: 'Boda',
    texto: 'El salón superó todas nuestras expectativas. El espacio es hermoso, el servicio impecable y nuestros invitados quedaron encantados.',
  ...
  },
  {
    nombre: 'Ana Martínez',
    evento: 'Quinceañera',
    texto: 'Fue el lugar perfecto para la quinceañera de mi hija. El equipo fue muy profesional y ayudó en cada detalle. ¡Altamente recomendado!',
  ...
  },
  {
    ...
    texto: 'Excelente para nuestro evento corporativo. Las instalaciones son modernas, el catering de primera calidad y el servicio excepcional.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            Testimonios de clientes satisfechos que celebraron sus eventos con nosotros
          </p>
        </motion.div>
