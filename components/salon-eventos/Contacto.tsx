...
export default function Contacto() {
  ...
  return (
    <section
      id="contacto"
      ref={ref}
      className="relative py-20 sm:py-32 bg-gradient-to-br from-amber-50 via-yellow-50 to-white"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            Contáctanos para conocer disponibilidad y recibir una cotización personalizada
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-amber-50">
              ...
              <div className="space-y-4">
                ...
                <motion.a
                  href="mailto:info@salonelegante.com"
                  whileHover={{ scale: 1.05, x: 10 }}
                  className="flex items-center gap-4 text-gray-700 hover:text-amber-600 transition-colors"
                >
                  <div className="w-12 h-12 rounded-full bg-gradient-to-r from-amber-600 to-yellow-600 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">info@salonelegante.com</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">123 Event Hall Street, City, Country</div>
                  </div>
                </motion.div>
              </div>
            </div>
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-amber-50"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full bg-gradient-to-r from-amber-600 to-yellow-600 text-white px-6 py-4 rounded-full font-bold text-lg shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center gap-2"
              >
