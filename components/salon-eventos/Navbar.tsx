        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            <div className="relative">
              <Building2 className="text-amber-600 w-6 h-6 sm:w-8 sm:h-8" />
              <motion.div
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-4 ml-4 pl-4 border-l border-gray-200">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-amber-600 to-amber-700 text-white px-6 py-2 rounded-full font-semibold text-sm shadow-lg hover:shadow-xl transition-shadow"
              >
                Reservar Ahora
              </motion.button>
            </div>
          ...
          >
            <div className="px-4 py-4 space-y-4">
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-amber-100">
                <a href="tel:+1234567890" className="text-gray-700 hover:text-amber-600">
                  <Phone size={24} />
                </a>
                <a href="mailto:info@salonelegante.com" className="text-gray-700 hover:text-amber-600">
                  <Mail size={24} />
                </a>
              </div>
              <button className="w-full bg-gradient-to-r from-amber-600 to-amber-700 text-white px-6 py-3 rounded-full font-semibold shadow-lg">
                Reservar Ahora
              </button>
            </div>
          </motion.div>
