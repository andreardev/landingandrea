...
export default function Contacto() {
  ...
  return (
    <section
      id="contacto"
      ref={ref}
      className="relative py-20 sm:py-32 bg-gradient-to-br from-green-50 via-emerald-50 to-white"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            Estamos aquí para hacer realidad la decoración floral de tus sueños. Solicita una cotización gratuita
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-green-50">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">info@floristeria.com</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">123 Flower Street, City, Country</div>
                  </div>
                </motion.div>
              </div>
            </div>
