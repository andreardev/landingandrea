      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 mb-8">
          ...
          <div>
            ...
            >
              <Flower2 className="w-6 h-6 sm:w-8 sm:h-8 text-green-400" />
              <span className="text-xl sm:text-2xl font-display font-bold">Floristería Elegante</span>
            </motion.div>
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
              Especialistas en decoración floral para eventos sociales. Transformamos espacios con belleza natural desde hace más de 20 años.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <a href="#eventos" className="hover:text-green-400 transition-colors">Tipos de Eventos</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@floristeria.com" className="hover:text-green-400 transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            &copy; 2024 Floristería Elegante. Todos los derechos reservados. Hecho con{' '}
            <motion.span
              animate={{ scale: [1, 1.2, 1] }}
              transition={{ duration: 1, repeat: Infinity }}
              className="inline-block"
            >
              <Flower2 className="w-4 h-4 text-green-400 inline" />
            </motion.span>
          </p>
        </div>
      </div>
